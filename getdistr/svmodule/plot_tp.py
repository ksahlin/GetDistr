...
def plot2(x_y_ins_true, x_y_ins_false, x_y_del_true, x_y_del_false):
	...
	print tot_fps
	sd1, = ax.plot(x_del_true[:6], y_del_true[:6],'^-b',label='del,$\sigma$=25')
	sd1, = ax.plot(x_ins_true[:6], y_ins_true[:6],'o--b',label='ins,$\sigma$=25')
	sd2, = ax.plot(x_del_true[6:12], y_del_true[6:12],'^-r',label='del,$\sigma$=50')
	sd2, = ax.plot(x_ins_true[6:12], y_ins_true[6:12],'o--r',label='ins,$\sigma$=50')
	sd3, = ax.plot(x_del_true[12:], y_del_true[12:],'^-g',label='del,$\sigma$=75')
	sd3, = ax.plot(x_ins_true[12:], y_ins_true[12:],'o--g',label='ins,$\sigma$=75')
	fps20_25,fps30_25,fps40_25,fp50_25,fp75_25,fp100_25 = ax.bar(left=[17.5,27.5,37.5,47.5,72.5,95],color='b',height=tot_fps[:6],width=5, label='FP,$\sigma=25$')
	fps20_50,fps30_50,fps40_50,fp50_50,fp75_50,fp100_50 = ax.bar(left=[17.5,27.5,37.5,47.5,72.5,95],color='r',height=tot_fps[6:12],width=5, label='FPs,$\sigma=50$')
	fps20_75,fps30_75,fps40_75,fp50_75,fp75_75,fp100_75 = ax.bar(left=[17.5,27.5,37.5,47.5,72.5,95],color='g',height=tot_fps[12:],width=5, label='FPs,$\sigma=75$')
	legend = ax.legend(loc='center left', shadow=True)
	ax.set_yticklabels([str(abs(x-20)) for x in ax.get_yticks()])
	ax.set_xlim([-30, 110])
	ax.set_ylim([-30, 110])
	...
	#plt.show()
	plt.savefig('/Users/ksahlin/Dropbox/GetDist/paper-Asmblthn-contest/figures/Clever_true.pdf', format='pdf')
	...
	tot_fps = map(add, fp_del,fp_ins)
	tot_fps = map(lambda x: -x, tot_fps)
	sd1, = ax.plot(x_del_false[:6], y_del_false[:6],'^-b',label='del,$\sigma$=25')
	sd1, = ax.plot(x_ins_false[:6], y_ins_false[:6],'o--b',label='ins,$\sigma$=25')
	sd2, = ax.plot(x_del_false[6:12], y_del_false[6:12],'^-r',label='del,$\sigma$=50')
	sd2, = ax.plot(x_ins_false[6:12], y_ins_false[6:12],'o--r',label='ins,$\sigma$=50')
	sd3, = ax.plot(x_del_false[12:], y_del_false[12:],'^-g',label='del,$\sigma$=75')
	sd3, = ax.plot(x_ins_false[12:], y_ins_false[12:],'o--g',label='ins,$\sigma$=75')
	fps20_25,fps30_25,fps40_25,fp50_25,fp75_25,fp100_25 = ax.bar(left=[17.5,27.5,37.5,47.5,72.5,95],color='b',height=tot_fps[:6],width=5, label='FP,$\sigma=25$')
	fps20_50,fps30_50,fps40_50,fp50_50,fp75_50,fp100_50 = ax.bar(left=[17.5,27.5,37.5,47.5,72.5,95],color='r',height=tot_fps[6:12],width=5, label='FPs,$\sigma=50$')
	fps20_75,fps30_75,fps40_75,fp50_75,fp75_75,fp100_75 = ax.bar(left=[17.5,27.5,37.5,47.5,72.5,95],color='g',height=tot_fps[12:],width=5, label='FPs,$\sigma=75$')
	legend = ax.legend(loc='center left', shadow=True)
	...
	#plt.show()
	plt.savefig('/Users/ksahlin/Dropbox/GetDist/paper-Asmblthn-contest/figures/Clever_false.pdf', format='pdf')
