...
def collect_libstats(infile):
	...
	param.total_basepairs = int(vals[4].strip().split())
...
def p_value_cluster(args):
	significant_regions = os.path.join(args.outfolder,'regions.gff')
	cluster_p_vals.main(args.bp_file, args.gap_file, significant_regions,param)
