...
def collect_libstats(args,outfolder,param):
	...
	param.mu = params["mu-raw"]
	param.sigma = params["sd-raw"]
	param.min_isize = params["min-isize"]
	param.max_isize = params["max-isize"]
	param.read_length = params["read-length"]
	param.adjusted_mu = params["mu-adjusted"]
	param.adjusted_sigma = params["sd-adjusted"]
	...
	param.ess_ratio = params["ess"]
	param.total_basepairs = params["genome-length"]
